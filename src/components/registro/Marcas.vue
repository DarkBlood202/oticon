            ...
            <div class="container bg-white rounded-xl shadow-md p-4 px-6 mx-auto mb-4">
                ...
                <form @submit.prevent="modificarMarca">
                    <div class="my-4">
                        ...
                        <label v-if="showRed" v-bind:class="!exists ? ['hidden'] : ['block', 'text-xs','text-red-500']">Marca ya existente.</label>
                        <label v-if="showRed" v-bind:class="marca.nombre ? ['hidden'] : ['block', 'text-xs','text-red-500']">Marca no puede quedar vacía.</label>
                    </div>
            ...
            <div class="container bg-white rounded-xl shadow-md p-4 px-6 mx-auto mb-4">
                ...
                <form @submit.prevent="agregarMarca">
                    <div class="my-4">
                        ...
                        <label v-if="showRed" v-bind:class="!exists ? ['hidden'] : ['block', 'text-xs','text-red-500']">Marca ya existente.</label>
                        <label v-if="showRed" v-bind:class="n_marca.nombre ? ['hidden'] : ['block', 'text-xs','text-red-500']">Marca no puede quedar vacía.</label>
                    </div>
                    <div class="grid grid-cols-2 gap-4 mt-10 mb-2">
