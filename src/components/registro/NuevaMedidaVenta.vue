        ...
        <div class="container bg-white rounded-xl shadow-md p-4 px-6 m-auto">
            ...
            <form @submit.prevent="agregarMedidaVenta">
                <div class="my-4">
                    ...
                    <input type="text" required v-model="medidaVenta.nombre" class="mt-1 pl-2 py-1 rounded-full border-2 border-yellow-500 w-full">
                </div>
                <div class="my-4">
                    <label class="uppercase">Abreviación</label><br>
                    <input type="text" required v-model="medidaVenta.abreviacion" class="mt-1 pl-2 py-1 rounded-full border-2 border-yellow-500 w-full">
                </div>
    ...
    methods: {
        agregarMedidaVenta(){
            fetch('/api/medidas-venta', {
                method: 'POST',
                body: JSON.stringify(this.medidaVenta),
                headers: {
